...
function initialize_collection:
    ...
    assert.eq self.caller aleo1dv6fre2y82gzw58aqga20v8mkjcjm8dj77s8fjfnnflcuhhx6y8qp9ml66;
...
function mint:
    ...
    output r7 as Zkoi_test1.aleo/mint.future;
...
function authorize:
    ...
    output r2 as Zkoi_test1.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as Zkoi_test1.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as Zkoi_test1.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as Zkoi_test1.aleo/convert_public_to_private.future;
