...
function transfer_private_to_public:
    ...
    output r5 as zkoi_test1.aleo/transfer_private_to_public.future;
...
function transfer_public_as_signer:
    ...
    output r5 as NFTView.record;
    output r6 as zkoi_test1.aleo/transfer_public_as_signer.future;
...
function transfer_public_to_private:
    ...
    output r5 as zkoi_test1.aleo/transfer_public_to_private.future;
