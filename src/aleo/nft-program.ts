export const NFTProgramId = 'zkoi_test1.aleo';

export const NFTProgram = `program zkoi_test1.aleo;
...
function transfer_priv_to_pub:
    ...
    output r5 as zkoi_test1.aleo/transfer_priv_to_pub.future;
...
function transfer_public:
    ...
    output r6 as zkoi_test1.aleo/transfer_public.future;
...
function transfer_pub_as_signer:
    ...
    output r5 as NFTView.record;
    output r6 as zkoi_test1.aleo/transfer_pub_as_signer.future;
...
function transfer_pub_to_priv:
    ...
    output r5 as zkoi_test1.aleo/transfer_pub_to_priv.future;
...
function set_for_all_approval:
    ...
    output r4 as zkoi_test1.aleo/set_for_all_approval.future;
...
function approve_public:
    ...
    output r7 as zkoi_test1.aleo/approve_public.future;
...
function transfer_from_public:
    ...
    output r9 as zkoi_test1.aleo/transfer_from_public.future;
...
function update_edition_private:
    ...
    output r2 as NFT.record;
    output r5 as zkoi_test1.aleo/update_edition_private.future;
...
function publish_nft_content:
    ...
    output r4 as zkoi_test1.aleo/publish_nft_content.future;
...
function mint:
    ...
    cast r2 r0 r1 into r6 as NFT.record;
    output r6 as NFT.record;
    output r5 as zkoi_test1.aleo/mint.future;
...
function initialize_collection:
    ...
    output r3 as zkoi_test1.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as zkoi_test1.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as zkoi_test1.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as zkoi_test1.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as zkoi_test1.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as zkoi_test1.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as zkoi_test1.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as zkoi_test1.aleo/open_mint.future;
...
function claim_nft:
    ...
    output r6 as zkoi_test1.aleo/claim_nft.future;
